...
const isLoading =useAppSelector(selectLoading);
  ...
  return (
    ...
    <Header/>
    <div className="Main">
      <QuestionBox questionText={question.title} questionImage={question.url} imagePhotoGrapher={question.id}/>
      <div className="Main__ButtonsBox"> 

        <button className="Main__Button" id="notSure" onClick={()=>{dispatch(postData(getSendData(FoodFactsType.NotSure)))}}>
        ...
        <button className="Main__Button" id="no" onClick={()=>{dispatch(postData(getSendData(FoodFactsType.No)))}}>
        ...
        <button className="Main__Button" id="yes" onClick={()=>{dispatch(postData(getSendData(FoodFactsType.Yes)))}}>
