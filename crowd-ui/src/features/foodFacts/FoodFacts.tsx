          ...
          <div className="Main">
            ...
            <div className="Main__ButtonsBox">
              ...
              >
                ...
                <span>
                  <FormattedMessage id="app.footer.notSure" defaultMessage="Not Sure" />
                </span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <span><FormattedMessage id="app.footer.no" defaultMessage="No" /></span>
              </button>
              <button
                type="button"
                className="Main__Button"
              ...
              >
                ...
                <span>
                  <FormattedMessage id="app.footer.yes" defaultMessage="No" />
                </span>
              </button>
            </div>
          </div>
